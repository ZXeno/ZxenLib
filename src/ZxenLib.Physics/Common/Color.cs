...
public struct Color
{
    public byte R => unchecked((byte)(this.Value >> ARGBRedShift));

    public byte G => unchecked((byte)(this.Value >> ARGBGreenShift));

    public byte B => unchecked((byte)(this.Value >> ARGBBlueShift));

    public byte A => unchecked((byte)(this.Value >> ARGBAlphaShift));
