...
public static partial class CollisionUtils
{
        ...
        int vertexIndexA)
    {
        ...
        float distance0 = Vector2.Dot(normal, vIn[0].Vector) - offset;
        float distance1 = Vector2.Dot(normal, vIn[1].Vector) - offset;
        ...
        GJkProfile gJkProfile)
    {
        ...
        DistanceAlgorithm.Distance(out DistanceOutput output, ref cache, input, gJkProfile);
