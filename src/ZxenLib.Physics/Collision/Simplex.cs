...
public struct Simplex
{
    ...
    public void WriteCache(ref SimplexCache cache)
    {
        ...
        for (int i = 0; i < this.Count; ++i)
        {
            cache.IndexA[i] = (byte) this.Vertices[i].IndexA;
            cache.IndexB[i] = (byte) this.Vertices[i].IndexB;
        }
    }
    ...
    public Vector2 GetSearchDirection()
    {
        ...
        {
            case 1:
                return -this.Vertices.Value0.W;

            case 2:
            {
                Vector2 e12 = this.Vertices.Value1.W - this.Vertices.Value0.W;
                float sgn = MathUtils.Cross(e12, -this.Vertices.Value0.W);
                if (sgn > 0.0f)
                {
            ...
            default:
                throw new ArgumentOutOfRangeException(nameof(this.Count));
        }
    }
    ...
    public Vector2 GetClosestPoint()
    {
        switch (this.Count)
        {
            ...
            case 2:
                return this.Vertices.Value0.A * this.Vertices.Value0.W + this.Vertices.Value1.A * this.Vertices.Value1.W;
    ...
    public void GetWitnessPoints(out Vector2 pA, out Vector2 pB)
    {
        ...
        {
            case 1:
                pA = this.Vertices.Value0.Wa;
                pB = this.Vertices.Value0.Wb;
                break;

            case 2:
                pA = this.Vertices.Value0.A * this.Vertices.Value0.Wa + this.Vertices.Value1.A * this.Vertices.Value1.Wa;
                pB = this.Vertices.Value0.A * this.Vertices.Value0.Wb + this.Vertices.Value1.A * this.Vertices.Value1.Wb;
                break;

            case 3:
                pA = this.Vertices.Value0.A * this.Vertices.Value0.Wa
                     + this.Vertices.Value1.A * this.Vertices.Value1.Wa
                     + this.Vertices.Value2.A * this.Vertices.Value2.Wa;
                pB = pA;
                break;
    ...
    public float GetMetric()
    {
        switch (this.Count)
        {
            ...
            case 2:
                return Vector2.Distance(this.Vertices.Value0.W, this.Vertices.Value1.W);

            case 3:
                return MathUtils.Cross(this.Vertices.Value1.W - this.Vertices.Value0.W, this.Vertices.Value2.W - this.Vertices.Value0.W);
    ...
    public void Solve2()
    {
        ref SimplexVertex v0 = ref this.Vertices.Value0;
        ref SimplexVertex v1 = ref this.Vertices.Value1;
        Vector2 w1 = v0.W;
        Vector2 w2 = v1.W;
        Vector2 e12 = w2 - w1;
        ...
        if (d12_1 <= 0.0f)
        {
            ...
            v1.A = 1.0f;
            this.Count = 1;
            this.Vertices.Value0 = this.Vertices.Value1;
            return;
        }
    ...
    public void Solve3()
    {
        ref SimplexVertex v0 = ref this.Vertices.Value0;
        ref SimplexVertex v1 = ref this.Vertices.Value1;
        ref SimplexVertex v2 = ref this.Vertices.Value2;
        Vector2 w1 = v0.W;
        Vector2 w2 = v1.W;
        Vector2 w3 = v2.W;
