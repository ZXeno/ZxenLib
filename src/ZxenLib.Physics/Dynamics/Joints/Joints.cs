...
public abstract class Joint
{
    ...
    public bool IsEnabled => this.BodyA.IsEnabled && this.BodyB.IsEnabled;

    /// Get collide connected.
    /// Note: modifying the collide connect flag won't work correctly because
    /// the flag is only checked when fixture AABBs begin to overlap.
    public bool IsCollideConnected => this.CollideConnected;
    ...
    {
        Transform xf1 = this.BodyA.GetTransform();
        Transform xf2 = this.BodyB.GetTransform();
        Vector2 x1 = xf1.Position;
        Vector2 x2 = xf2.Position;
        Vector2 p1 = this.GetAnchorA();
        Vector2 p2 = this.GetAnchorB();
        ...
        switch (this.JointType)
        {
            ...
            {
                Color c = Color.FromArgb(0.0f, 1.0f, 0.0f);
...
public static class JointUtils
{
        ...
        Body bodyB)
    {
        ...
        float omega = 2.0f * Settings.Pi * frequencyHertz;
