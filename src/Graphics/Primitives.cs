...
public static class Primitives
{
    ...
    /// <summary>
    /// Writes a given color to a pixel coordinate.
    /// </summary>
    /// <param name="spriteBatch">The <see cref="SpriteBatch"/> writing the pixel data.</param>
    ...
    /// </summary>
    /// <param name="spriteBatch">The <see cref="SpriteBatch"/> writing the pixel data.</param>
    /// <param name="position">The <see cref="Vector2"/> coordinate to write to.</param>
    /// <param name="color">The <see cref="Color"/> to write.</param>
