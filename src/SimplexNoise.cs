 ...
 * converted from the java code found here:
 ...
 * This copy converted to C# by Jonathan Cain 2015
 *
...
public class SimplexNoise
{
    ...
    private static short[] p =
    {
        ...
        104, 218, 246, 97, 228, 251, 34, 242, 193, 238, 210, 144, 12, 191, 179, 162, 241, 81, 51, 145, 235,
        249, 14, 239, 107, 49, 192, 214, 31, 181, 199, 106, 157, 184, 84, 204, 176, 115, 121, 50, 45, 127,
    ...
    /// <param name="w"></param>
    /// <returns></returns>
    public static double noise(double x, double y, double z, double w) // better simplex rank ordering method 2012-03-09
    {
